      ...
      <div className='user'>
          <div className='user1'>
              <div >
                    ...
                    <p>Hireable : <i class="fa-solid fa-check"></i></p>
               </div> 
          </div>
          <div className='user2'>
              ...
              <div className='user2-2'>
               ...
               <div className='user3'>
                   <div className='user3-1'>
                    <button className='btn btn-danger me-3 '>followers: {user.followers}</button>
                    <button className='btn btn-success me-3 '>following: {user.following} </button>
                    <button className='btn btn-light  me-3    btn btn-outline-secondary'>Public repo: {user.public_repos}</button>
